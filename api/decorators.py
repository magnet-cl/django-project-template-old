...
def api_method(single=False, expected_methods=['get'],
    ...
    """
    api_method is a decorator with parameters for a custom api endpoint,
    dealing with the common tasks that does not concern the method itself, like
    checking if the request method is allowed or packing the response in an api
    friendly way
